...
PRIVATE_KEY="../certs/CUmakeit_01.private.key"
DEVICE_CERT="../certs/device.pem.cert"
DEVICE_NAME="CUmakeit_01"
CA_CERT="../certs/root-CA.crt"
THING_ENDPOINT="a5oyk3iuhy30n-ats.us-east-1.amazonaws.com"
TOPIC="thing/makerspace_pi/signin"
PORT=8883
THING_NAME="CUmakeit_01"
LOCATION="Watt Center"
EVENT="SignIn"
HAT_CONNECTED="True"
