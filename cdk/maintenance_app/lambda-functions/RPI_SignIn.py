...
def RPI_SignIn_Handler(event, context):
    ...
    try:
        ...
        try:
            ...
            new_login = {"visitor_id": str(response["visitor_id"]), "date_visited": time_in, "first_visit": first_visit, "login_location": str(
                location), "sign_in_time": time_in, "visit_id": str(visit_id)}
