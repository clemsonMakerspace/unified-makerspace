...
class MaintenanceAppStack(core.Stack):
    ...
    # -------------------DynamoDB Tables-----------------------
        ...
        machinesTable = ddb.Table(
            self, 'Machines',
            partition_key={'name': 'machine_name',
                           'type': ddb.AttributeType.STRING},
            table_name='Machines',
            billing_mode=ddb.BillingMode('PAY_PER_REQUEST')
        )
        ...
        visitorsTable = ddb.Table(
            self, 'Visitors',
            partition_key={'name': 'hardware_id',
                           'type': ddb.AttributeType.STRING},
            table_name='Visitors',
            billing_mode=ddb.BillingMode('PAY_PER_REQUEST')
        )
        ...
        visitsTable = ddb.Table(
            self, 'Visits',
            partition_key={'name': 'visitor_id',
                           'type': ddb.AttributeType.STRING},
            sort_key={'name': 'sign_in_time',
        ...
        userVerificationTokenTable = ddb.Table(
            ...
            partition_key={'name': 'generatedToken',
                           'type': ddb.AttributeType.STRING},
...
# #----------------IoT--------------------------
        ...
        CUmakeit_IoT_Policy = iot.CfnPolicy(
            self, "IoT_All_Allowed", policy_name="IoT_All_Allowed", policy_document=IoT_All_Allowed_Policy)
