// This code was modified from its source (found in S3.gs) to support https requests (previously was http)
// S3Request.prototype.getAuthHeader_ and S3Request.prototype.getUrl were modified to use https urls
