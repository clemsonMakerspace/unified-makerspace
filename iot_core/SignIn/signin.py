...
# If you need to add more command line arguments to this function, add
# them here.
...
def connectToAWS(cardID):
    ...
    mqtt_connection = mqtt_connection_builder.mtls_from_path(
        ...
        # on_connection_resumed=on_connection_resumed, # Don't know what this
        # is; don't touch it
