...
def test_signin_visitor_in_DB_hardwareID220722_locationTest_equals_200():
    url ="https://9bhfui3vn2.execute-api.us-east-1.amazonaws.com/rpi/signin"
    ...
    assert res_body["statusCode"] == 200
...
def test_signin_visitor_is_not_in_DB_hardwareID000000_locationTest_equals_402():
    ...
    assert res_body["statusCode"] == 402
...
def test_signout_visitor_in_DB_hardwareID220722_equals_200():
    url ="https://9bhfui3vn2.execute-api.us-east-1.amazonaws.com/rpi/signout"
...
if __name__ == "__main__":
    ...
    test_signout_visitor_not_in_DB_hardwareID220722_equals_402()
