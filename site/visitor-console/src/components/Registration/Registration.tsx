        ...
        return (
            <div className="container bg-primary p-5 rounded">
                <div className="text-center mb-4">
                    <h1 className="text-secondary fw-bold mb-1 text-center">Register to the Makerspace!</h1>
                    <span className="text-center text-light">Please Fill in Registration Information</span>
                </div>
                <div className="d-flex flex-column align-items-center text-light">
                    <form className="row" onSubmit={handleSubmit} style={{maxWidth: '30rem'}}>
                        ...
                        <div className="col-md-6">
                            ...
                            <Select className="text-black" id="gender"
                        ...
                        {/* grad date */}
                        <div className="col-12 mb-2">
                            <label htmlFor="graddate" className="form-label">Expected Graduation Date</label>
                            <input type={"date"} className="form-control"
                                value={expGradDate} id="graddate"
